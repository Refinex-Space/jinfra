...
```xml
<properties>
    <automatic.module.name>refinex.cn.jinfra.core</automatic.module.name>
</properties>
```
...
|---|---|
| `jinfra-all` | `refinex.cn.jinfra.all` |
| `jinfra-core` | `refinex.cn.jinfra.core` |
| `jinfra-context` | `refinex.cn.jinfra.context` |
| `jinfra-id` | `refinex.cn.jinfra.id` |
| `jinfra-io` | `refinex.cn.jinfra.io` |
| `jinfra-codec` | `refinex.cn.jinfra.codec` |
| `jinfra-crypto` | `refinex.cn.jinfra.crypto` |
| `jinfra-json` | `refinex.cn.jinfra.json` |
| `jinfra-http` | `refinex.cn.jinfra.http` |
| `jinfra-validation` | `refinex.cn.jinfra.validation` |
| `jinfra-office` | `refinex.cn.jinfra.office` |
| `jinfra-excel` | `refinex.cn.jinfra.excel` |
| `jinfra-word` | `refinex.cn.jinfra.word` |
| `jinfra-ppt` | `refinex.cn.jinfra.ppt` |
| `jinfra-redis` | `refinex.cn.jinfra.redis` |
| `jinfra-redis-lettuce` | `refinex.cn.jinfra.redis.lettuce` |
| `jinfra-redis-spring` | `refinex.cn.jinfra.redis.spring` |
| `jinfra-lock` | `refinex.cn.jinfra.lock` |
| `jinfra-lock-redis` | `refinex.cn.jinfra.lock.redis` |
| `jinfra-lock-redisson` | `refinex.cn.jinfra.lock.redisson` |
| `jinfra-mq` | `refinex.cn.jinfra.mq` |
| `jinfra-mq-redis` | `refinex.cn.jinfra.mq.redis` |
| `jinfra-cache` | `refinex.cn.jinfra.cache` |
| `jinfra-cache-caffeine` | `refinex.cn.jinfra.cache.caffeine` |
| `jinfra-cache-redis` | `refinex.cn.jinfra.cache.redis` |
| `jinfra-spring` | `refinex.cn.jinfra.spring` |
| `jinfra-spring-boot-autoconfigure` | `refinex.cn.jinfra.spring.boot.autoconfigure` |
| `jinfra-spring-boot-starter` | `refinex.cn.jinfra.spring.boot.starter` |
| `jinfra-redis-spring-boot-starter` | `refinex.cn.jinfra.redis.spring.boot.starter` |
| `jinfra-office-spring-boot-starter` | `refinex.cn.jinfra.office.spring.boot.starter` |
| `jinfra-test` | `refinex.cn.jinfra.test` |
...
Use `apply_patch` to create `/Users/refinex/develop/project/jinfra/jinfra-all/pom.xml` with a normal jar module, automatic module name `refinex.cn.jinfra.all`, and dependencies listed for `jinfra-all` in the dependency matrix. The file must not include any dependency whose artifactId ends with `spring-boot-starter`.
